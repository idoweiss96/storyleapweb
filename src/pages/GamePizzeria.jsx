...
import Pizzeria from '@/components/games/pizzeria/Pizzeria';
import { META, UI } from '@/components/games/pizzeria/pizzeriaContent';

export default function GamePizzeria() {
