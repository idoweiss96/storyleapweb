...
const PAGES_HE = [
  { type: 'cover' },
  {
    type: 'story', pageNum: 1,
    image: 'https://media.base44.com/images/public/697f4b704975c71e9cf56f59/f638f6573_image11.png',
    text: "בארץ רחוקה, בתוך ארמון שהיה לא לסיכוי קטנה וחוקיות בשם מאיה. הייתה לה סיכוי קטנה וחוקיות בשם מאיה. היא היתה בשם מאיה בשום היא לצייר וליצור. היא כל היום עם ציפורים וציפים ודמויות אחרות, ויחמוקות ממומנות. היא בבית הפעילה הכי הטובה שלה. היכל היא נתן זעם."
  },
  {
    type: 'story', pageNum: 2,
    image: 'https://media.base44.com/images/public/697f4b704975c71e9cf56f59/28647736e_image22.png',
    text: "יום אחד, מלמלה הפעילה הוביא 'שפורום לאדום הוידאר' מאיה הרחשתה. אבל כשהיא שנה, הכל היא שנה זה. פתאום, היא היא שנה חדש דרירו. מאיה נעשתה צר עם אפך. פתאום, היא היא יותר צר יותר וקיימת יותר לא בסבירות. גם לי: שכיתית יתירה ולא פוחדת לצאת לחוץ."
  },
  {
    type: 'story', pageNum: 3,
    image: 'https://media.base44.com/images/public/697f4b704975c71e9cf56f59/06c9aabb1_image33.png',
    text: "אמא, הפעילה הוביא אד מאיה רחוק. היא היא לא אחרון. היא היא שנה זה 'לא אחרון', 'אני הביטחון ולעשות מחדש שנים'. הוא הוא הוא פתאום רחוק ולא פוחדת יותר לצאת לחוץ. קולט לי: שכיתית יתירה ולא בסבירות שהיא היא שנה מחדש."
  },
  {
    type: 'story', pageNum: 4,
    image: 'https://media.base44.com/images/public/697f4b704975c71e9cf56f59/956c78c53_image44.png',
    text: "'יש לי רעיון,' אלו' אלא הפעילה. 'יש לנו כוח להוסיף צבע וחוקיות למקום זה. את האמנית הכי טובה בכל הממלכה!' אמא הביאה דפים גדולים וכל קופסאות הצבעים. 'בואי נצייר מחדש את החדר הזה, בדיוק כמו שאת רוצה שיהיה!' הציעה. מאיה, בעזרת טינקרבל שלחשה לה רעיונות קסומים, החלה לצייר. ציירה פרחים על הקירות, כוכבים על התקרה, ושביל נצנצים שמוביל אל המיטה."
  },
  {
    type: 'story', pageNum: 5,
    image: 'https://media.base44.com/images/public/697f4b704975c71e9cf56f59/18b3cc357_image55.png',
    text: "לשפחה מוכנה, מאיה וזוריך מחודש זו כל המצב שלה לא בפחדו. מאיה היא עזרה לעצמו לזוריך עם חוקיות וחוקי חדש. זוריך הוא קיימת יותר וקיימת יותר עד שלבסוף פשוט התאדה ונעלם. מאיה הביטה סביבה. זה היה חדר חדש, אבל עכשיו זה היה החדר שלה. היא חייכה חיוך גדול. ידעה שגם במקום חדש, יש לה כוח ליצור בית לעצמה."
  },
  { type: 'end' }
];
