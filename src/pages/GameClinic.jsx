...
import Clinic from '@/components/games/clinic/Clinic';
import { META, UI } from '@/components/games/clinic/clinicContent';

export default function GameClinic() {
