...
const faqData = {
  he: {
    ...
    items: [
      ...
      { q: 'איך משלמים?', a: 'התשלום מתבצע באמצעות קרדיטים שרוכשים באתר, בכרטיס אשראי או PayPal. סיפור מותאם אישית עולה מ-₪110. ניתן לצפות במחירים המלאים בעמוד רכישת הקרדיטים בלי להתחבר, וההתחברות נדרשת רק בשלב התשלום עצמו.' },
  ...
  en: {
    ...
    items: [
      ...
      { q: 'How do I pay?', a: 'Payment is made using credits purchased on the site, via credit card or PayPal. A personalized story starts from $40. You can view full pricing on the credits page without signing in, sign in is only required at the actual payment step.' },
