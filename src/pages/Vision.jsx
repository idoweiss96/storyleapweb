...
const content = {
  ...
  he: {
    ...
    values: [
      ...
      { icon: '🔍', name: 'שקיפות מלאה', desc: 'מותר לטעות — כל עוד מראים את זה, מדברים על זה ומתקנים. אנחנו מחזיקים את עצמנו בסטנדרט הזה כחברה ומדגימים אותו למשפחות שאנחנו משרתים.', color: '#9ab8d0' },
