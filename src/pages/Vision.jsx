...
const content = {
  ...
  he: {
    ...
    originText: 'בימים הראשונים של המלחמה, ראינו משפחות מתמודדות עם פחד, פרידה ואי-ודאות עם ילדיהן — בלי הידע או הכלים לעזור להם לעבור את זה. ראינו הורים שאהבו את ילדיהם עמוקות, אך הרגישו חסרי אונים. ידענו שהטכנולוגיה יכולה לעשות יותר. אז התחלנו לבנות.',
    believeLabel: 'במה אנחנו מאמינים',
    believeTitle: 'לכל ילד יש סיפור משלו.',
    believe1: ['ילדים אינם קטגוריה. כל ילד נושא עולם רגשי ייחודי, שעוצב על ידי משפחתו, חוויותיו, פחדיו וחוזקותיו. ', 'תמיכה גנרית לעתים קרובות נכשלת', ' — לא מפני שהכוונה אינה שם, אלא מפני שהיא אינה מדברת אל מי שהילד באמת הוא.'],
    believe2: ['אנחנו מאמינים ש', 'ההורים הם הכוח החזק ביותר בחיים הרגשיים של הילד.', ' לא מטפלים, לא מורים — הורים. הבעיה אינה שהורים לא אכפת להם. הבעיה היא שלעתים קרובות חסרים להם הכלים, השפה, ההדרכה — להפוך את האהבה שלהם לסוג הנכון של תמיכה. וכשהם לא מצליחים לעזור, הם מרגישים את זה עמוקות.'],
    believe3: ['אנחנו גם מאמינים ש', 'מטפלים ואנשי מקצוע ראויים לכלים טובים יותר.', ' השיטות שהם משתמשים בהן מוכחות. מה שחסר הוא הטכנולוגיה להעביר שיטות אלו מהר יותר, אישי יותר, ועם טווח הגעה רחב יותר. StoryLeap בונה את הטכנולוגיה הזו.'],
    serveLabel: 'את מי אנחנו משרתים',
    serveTitle: 'שלושה שותפים. מסע אחד.',
    serve: [
      { icon: '🩺', role: 'המטפל/ת', desc: 'אנחנו נותנים לאנשי מקצוע כלים מבוססי AI ליצירת תוכן טיפולי מותאם אישית לכל ילד שהם עובדים איתו, ומאריכים את השפעתם מעבר לפגישה.', tag: 'שותף ראשי' },
      ...
      { icon: '🌱', role: 'הילד/ה', desc: 'כל סיפור, סרטון ותרגיל נבנה סביבם. הם רואים את עצמם כגיבורים, בונים כלי התמודדות אמיתיים, וצומחים מאתגרים שפעם התמודדו איתם לבד.', tag: 'המוטב העיקרי' },
    ],
    journeyLabel: 'מסע ההורה',
    journeyTitle: 'מחסרי אונים — לחמושים בכלים.',
    journey: [
      { emoji: '😔', emotion: 'מתוסכלים', sub: 'הילד שלי מתקשה ואני לא יודע/ת מה לעשות' },
      { emoji: '💛', emotion: 'מוקלים', sub: 'זה בסדר. אנחנו לא לבד בזה' },
      { emoji: '🤝', emotion: 'מחוברים', sub: 'יש לי כלים. אני יכול/ה לעשות את זה עם הילד שלי' },
      { emoji: '🌿', emotion: 'מועצמים', sub: 'צמחנו מזה ביחד' },
    ],
    valuesLabel: 'הערכים שלנו',
    valuesTitle: 'על מה לא נתפשר לעולם.',
    values: [
      { icon: '👨‍👩‍👧', name: 'הורים קודם', desc: 'ההורים הם המפתח לחוסן הרגשי של הילד. אנחנו בונים כלים שנותנים להם ידע, ביטחון ודרך ברורה פנימה.', color: '#c4a0d0' },
      { icon: '🌀', name: 'התאמה אישית רדיקלית', desc: 'לכל ילד יש רגשות וסיפור משלו. לעולם לא נציע תשובה אחת לכולם למשהו אישי כמו עולמו הפנימי של הילד.', color: '#5a7a9a' },
      { icon: '🔍', name: 'שקיפות כנה', desc: 'מותר לטעות — כל עוד מראים את זה, מדברים על זה ומתקנים. אנחנו מחזיקים את עצמנו בסטנדרט הזה כחברה ומדגימים אותו למשפחות שאנחנו משרתים.', color: '#9ab8d0' },
      { icon: '⚡', name: 'טכנולוגיה עם מטרה', desc: 'אנחנו מרתמים את מה ש-AI מאפשר — לא למען עצמו, אלא כדי לתת למטפלים, הורים וילדים כלים טובים יותר מאי פעם.', color: '#b0c9a0' },
    ],
    visionLabel: 'חזון ל-10 שנים',
    visionText1: 'StoryLeap תהיה ',
    visionBold: 'המצפן להתפתחות הרגשית של ילדים',
    visionText2: ' — פלטפורמה שעוזרת להורים לנווט את האתגרים שילדיהם מתמודדים איתם, ונותנת למטפלים ואנשי מקצוע כלים להנחות, לעקוב ולתמוך במסע הלקוחות שלהם בבהירות ובביטחון.',
    visionText3: 'עולם שבו שום הורה לא מרגיש חסר אונים, ואף ילד לא מתמודד עם האתגרים שלו לבד.',
    howLabel: 'איך אנחנו מגיעים לשם',
    howTitle: 'צעד אחר צעד, סיפור אחר סיפור.',
    how1: ['אנחנו מתחילים היכן שהצורך הוא המידי ביותר: ', 'סיפורים טיפוליים מותאמים אישית', ' שנבנים סביב האתגר האמיתי של כל ילד, ומבוססים על שיטות קליניות שמטפלים כבר משתמשים בהן. אנחנו מוכיחים שזה עובד. מקשיבים למשפחות ולאנשי מקצוע. ומשכללים עד שהמוצר זוכה באמון.'],
    how2: 'משם, אנחנו מתרחבים. סיפורים הופכים לסרטונים, אמנות ומשחקים — ערכת כלים טיפוליים שלמה שמטפלים יכולים להשתמש בה עם הלקוחות שלהם, וההורים יכולים להמשיך בה בבית בין הפגישות. המטפל וההורה עובדים יחד, עם StoryLeap כגשר ביניהם.',
    how3: 'עם הזמן, הגשר הזה הופך לפלטפורמה — כזו שמחברת בין העולם הקליני לבית, הופכת תמיכה רגשית ברמה מקצועית לנגישה לכל משפחה, ומצמצמת את המרחק בין "אני לא יודע איך לעזור" ל"אני יודע בדיוק מה לעשות".',
    roadmapLabel: 'המסע קדימה',
    roadmapTitle: 'מסיפורים לפלטפורמה שלמה.',
    roadmap: [
      { num: 'עכשיו', title: 'סיפורים מותאמים אישית', desc: 'ספרי סיפורים טיפוליים שנבנים סביב האתגר האמיתי של כל ילד, מבוססים על ביבליותרפיה ו-CBT. מוכיחים שהמודל עובד עם משפחות ואנשי מקצוע אמיתיים.' },
      { num: 'הבא', title: 'ארגז הכלים של המטפל', desc: 'סיפורים מתרחבים לסרטונים, תרגילי אמנות ומשחקים. מטפלים מקבלים פלטפורמה להקצאה, מעקב והתאמת תוכן מותאם לכל לקוח.' },
      { num: 'חזון', title: 'המנחה הרגשי', desc: 'פלטפורמה שמלווה משפחות בכל שלב בהתפתחות הרגשית של הילד, ומחברת מטפלים והורים סביב המסע הייחודי של כל ילד.' },
    ],
    closing: 'לא התחלנו את זה כי זו הייתה הזדמנות עסקית טובה. התחלנו את זה כי ראינו ילדים שזקוקים לעזרה, והורים שרצו לתת אותה — וידענו שאנחנו יכולים לבנות את הגשר ביניהם.',
  }
};
