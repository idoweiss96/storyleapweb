...
export default function CreateStory() {
  ...
  const hasCredits = userCredits >= 60;
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      {isCreating ? (
                        ...
                        <span className="flex items-center gap-2"><Sparkles className="w-5 h-5" />{isHe ? 'צור ספר (60 ⭐)' : 'Create Book (60 ⭐)'}</span>
                      )}
                    </Button>
                  </div>
                ) : (
                  <div className="space-y-4">
                    <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl text-center">
                      <p className="text-amber-800 font-semibold mb-1">
                        {isHe ? '⚠️ נדרשים 60 קרדיטים ליצירת ספר' : '⚠️ 60 credits required to create a book'}
                      </p>
