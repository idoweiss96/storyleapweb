...
export default function SLHero({ onStart }) {
  ...
  return (
    <section style={{ position: 'relative', maxWidth: 1120, margin: '0 auto', padding: '72px 32px 40px', textAlign: 'center' }}>
      ...
      <p style={{ maxWidth: 700, margin: '28px auto 0', fontSize: 23, lineHeight: 1.6, color: '#535862', fontWeight: 400 }}>Children don't always have the words for what they're feeling. StoryLeap helps you talk, understand and connect through personalized stories, games and activities.</p>
