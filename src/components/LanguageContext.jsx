...
const translations = {
  he: {
    ...
    feature1_title: 'מותאם אישית לילד/ה שלכם', feature1_desc: 'סיפור, פעילויות והכוונה להורים - הכל נבנה סביב מה שהילד/ה שלכם עובר/ת עכשיו',
    ...
    feature4_title: 'שיחה מודרכת', feature4_desc: 'כל סיפור מגיע עם שאלות מנחות להורה, לפתיחת שיחה רגשית אמיתית',
    hero_pill_stories: 'כבר יצרנו יחד מעל 200 חוויות', hero_pill_digital: 'סיפור דיגיטלי, מוכן תוך שעות בודדות',
    hero_pill_bibliotherapy: 'מבוסס על עקרונות מתחום הטיפול הרגשי בילדים',
    hero_headline: 'הורות מגיעה עם רגעים שלא תמיד יודעים איך להתמודד איתם',
    hero_headline_sub: 'סטוריליפ הופכת רגעים כאלה לחוויות פשוטות ומותאמות אישית שאתם והילד/ה שלכם עוברים יחד, עם סיפורים, פעילויות והדרכה מעשית',
    hero_chips_title: 'עם מה הילד/ה שלך מתמודד/ת כרגע?',
    chip_new: 'מתחילים משהו חדש',
    chip_fear: 'מתמודדים עם פחד',
    chip_moving: 'עוברים דירה',
    chip_friendship: 'קשיים חברתיים',
    chip_separation: 'פרידה',
    chip_emotions: 'רגשות גדולים',
    chip_other: 'משהו אחר',
    badge_new: 'חדש',
    ...
    cta_title: 'מוכנים להתחיל? ✨',     cta_subtitle: 'הצטרפו עכשיו וקבלו 10 קרדיטים חינם ליצירת הסיפורים הראשונים שלכם', cta_btn: 'התחילו עכשיו',
    ...
    create_title: 'בואו נבין מה עובר על הילד/ה שלכם', create_subtitle: 'כמה דקות ביחד, ונבנה משהו אישי שיעזור, סיפור, ודרכים לדבר על זה',
    helping_with: 'עוזרים עם:',
    ...
    form_submit: 'צרו את הסיפור שלי', form_writing: 'הפיה כותבת את הסיפור...',     form_creation_cost: 'עלות יצירה: 110 קרדיטים',
    ...
    ch_fears: 'פחדים', ch_social: 'קושי חברתי', ch_changes: 'התמודדות עם שינויים', ch_emotional: 'ויסות רגשי', ch_separation: 'קושי בפרידות', ch_confidence: 'ביטחון עצמי', ch_sleep: 'קשיי שינה',
    ...
    cta_desc: 'קבלו הכוונה, פעילויות, וסיפור מותאם אישית שנבנה סביב הרגע של הילד/ה שלכם.',
    pricing_badge: 'הצעה מיוחדת', pricing_title: 'סיפור מותאם אישית ✨', pricing_subtitle: 'סיפור מותאם אישית לילד/ה שלכם, נשלח תוך 24 שעות',
  ...
  en: {
    ...
    hero_pill_bibliotherapy: 'Based on child development principles',
    hero_headline: 'Parenting comes with moments you don\'t always know how to handle',
    hero_headline_sub: 'StoryLeap turns those moments into simple, personalized experiences you and your child can go through together, through stories, activities and practical guidance',
    hero_chips_title: 'What is your child going through?',
    chip_new: 'Starting something new',
    chip_fear: 'Dealing with fear',
    chip_moving: 'Moving house',
    chip_friendship: 'Friendship challenges',
    chip_separation: 'Separation',
    chip_emotions: 'Big emotions',
    chip_other: 'Something else',
    badge_new: 'New',
    ...
    cta_title: 'Ready to start? ✨',     cta_subtitle: 'Join now and get 10 free credits to create your first stories', cta_btn: 'Start Now',
    ...
    create_title: "Let's understand what your child is going through", create_subtitle: "A few minutes together, and we'll build something personal to help, a story, and ways to talk about it",
    helping_with: 'Helping with:',
    ...
    form_submit: 'Create My Story', form_writing: 'The fairy is writing the story...',     form_creation_cost: 'Creation cost: 110 credits',
    ...
    ch_fears: 'Fears', ch_social: 'Social Difficulty', ch_changes: 'Coping with Changes', ch_emotional: 'Emotional Regulation', ch_separation: 'Trouble with Goodbyes', ch_confidence: 'Self Confidence', ch_sleep: 'Sleep Issues',
    ...
    cta_desc: "Get guidance, activities, and a personalized story built around your child's moment.",
    pricing_badge: 'Special Offer', pricing_title: 'Personalized Story ✨',     pricing_subtitle: 'A personalized story tailored for your child, delivered within 24 hours',
