...
const translations = {
  he: {
    ...
    hero_pill_stories: 'כבר יצרנו יחד מעל 200 סיפורים', hero_pill_digital: 'סיפור דיגיטלי, מוכן תוך דקות',
    badge_new: 'חדש',
  ...
  en: {
    ...
    hero_pill_stories: '200+ stories created so far', hero_pill_digital: 'Digital story, ready in minutes',
    badge_new: 'New',
