...
const translations = {
  he: {
    ...
    form_submit: 'צרו את הסיפור שלי', form_writing: 'הפיה כותבת את הסיפור...',     form_creation_cost: 'עלות יצירה: 60 קרדיטים',
  ...
  en: {
    ...
    form_submit: 'Create My Story', form_writing: 'The fairy is writing the story...',     form_creation_cost: 'Creation cost: 60 credits',
