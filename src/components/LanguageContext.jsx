...
const translations = {
  he: {
    ...
    cta_title: 'מוכנים ליצור קסם? ✨',     cta_subtitle: 'הצטרפו עכשיו וקבלו 10 קרדיטים חינם ליצירת הסיפורים הראשונים שלכם', cta_btn: 'התחילו עכשיו',
  ...
  en: {
    ...
    cta_title: 'Ready to create magic? ✨',     cta_subtitle: 'Join now and get 10 free credits to create your first stories', cta_btn: 'Start Now',
