...
const translations = {
  he: {
    ...
    t1_name: 'מיכל כ.', t1_text: 'ישבנו לקרוא ביחד ובסוף נמצאנו בוכים שנינו, אבל מהסוג הטוב. היא שאלה אותי "אמא, גם לך יש פחדים?" זה פתח שיחה שלא ידעתי שאנחנו צריכים.',
    t2_name: 'דנה א.', t2_text: 'לא ציפיתי להרבה, כנה אני חשבתי שזה עוד דבר שינסה ולא יצליח. אבל הוא ביקש לקרוא שוב למחרת. ואחרי שלישית הוא התחיל לדבר. פשוט ככה.',
    t3_name: 'יוסי ל.', t3_text: 'היינו לפני שינוי גדול במשפחה ופחדתי מהתגובה של הבן שלי. הסיפור הפך את זה לשיחה בין שנינו, לא לעימות. לא יודע איך אבל זה עבד.',
    t4_name: 'רחל מ.', t4_text: 'שלושה שבועות של בכי כל בוקר ביציאה לגן. אחרי שהתחלנו לקרוא את הסיפור בלילה, שבוע אחר כך היא נפרדה ממני בנשיקה ורצה פנימה. אני עדיין לא מאמינה.',
    t5_name: 'אייל ד.', t5_text: 'הפרטים שנכנסו לסיפור הפתיעו אותי - לגו, הכלב שלנו, השם של החבר הכי טוב שלו. הוא הסתכל עליי ואמר "זה אני!" וצחק. זה היה שווה הכל.',
    t6_name: 'שרה ב.', t6_text: 'הבן שלי לא מדבר הרבה. אבל אחרי הסיפור הוא שאל אם הדמות הראשית מרגישה בודדה. הבנתי שהוא מדבר על עצמו. קנינו עוד סיפור אותו שבוע.',
