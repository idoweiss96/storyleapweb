...
export const UI = {
  he: {
    title: 'נשימות',
    subtitle: 'עוצרים לרגע ונושמים יחד. כמה נשימות פשוטות שיעזרו להירגע, להתמקד ולהרגיש קצת יותר בטוח.',
    ...
    parentTip: 'נשמו יחד, לא מהצד. כשהילד רואה אתכם נושמים איתו, הנשימה הופכת למשהו שעושים יחד ולא לתרגיל שמבקשים ממנו לעשות. וזה גם עוזר לכם להאט ולהירגע יחד.',
