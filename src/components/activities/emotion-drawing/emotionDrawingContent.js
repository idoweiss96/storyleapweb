...
export const UI = {
  he: {
    ...
    parentTip: 'במקום לשאול "מה ציירת?", נסו "ספרו לי על הציור". ככה לא מבקשים מהילד להסביר, אלא נותנים לו מקום לשתף במה שירצה. ולפעמים הציור פשוט יכול להיות ציור, גם זה בסדר.',
