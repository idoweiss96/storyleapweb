...
export const FIXED_TAG_OPTIONS = ['Kita Alef 2026', 'Paid', 'Pending Payment', 'Gifted Credits', 'Hebrew', 'English'];
...
export function computeAutoTags({ stories = [], kitaStories = [], hasGiftedCredits = false }) {
  const tags = new Set();
