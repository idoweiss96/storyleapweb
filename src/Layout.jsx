...
function LayoutInner({ children, currentPageName }) {
  ...
  return (
    <div dir={isRTL ? 'rtl' : 'ltr'} className="min-h-screen" style={{background: 'linear-gradient(135deg, #c5d8f5 0%, #e8f0fb 15%, #ffffff 35%, #fff8ed 50%, #fdd4dc 65%, #f5c4d8 80%, #edb5d0 100%)'}}>
      <style>{`
        @keyframes twinkle {
