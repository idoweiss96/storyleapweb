...
const HEADERS = {
  he: [
    ...
    'חברים מהגן שגם עולים לכיתה א', 'אח/ות גדול/ה - מה אמר/ה', 'תמונות משפחה - קישורים',
  ...
  en: [
    ...
    'Friends from kindergarten also going', 'Older sibling - What they said', 'Family Photo Links',
...
const SAMPLE_ROW = {
  he: [
    ...
    'חברה שלי דנה', 'אח גדול אמר שזה כיף', 'https://storage.example.com/mom.jpg, https://storage.example.com/dad.jpg',
  ...
  en: [
    ...
    'My friend Mia', 'Older brother said it is fun', 'https://storage.example.com/mom.jpg, https://storage.example.com/dad.jpg',
