  ...
  try {
    ...
    const body = isHebrew
      ? `<div dir="rtl" style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;color:#1e293b;line-height:1.8;">
          ...
          <p style="font-size:15px;">🤍 אחרי הקריאה, אפשר לעצור רגע יחד ולפתוח שיחה קטנה ונעימה.<br/>
          ...
          <ul style="font-size:15px;padding-right:20px;">
            <li>איך היה לך לשמוע את הסיפור?</li>
            <li>איזה חלק הכי אהבת?</li>
            <li>היה רגע שהרגיש לך ממש מוכר?</li>
            <li>איזו תמונה או רגע נשארו לך בראש?</li>
            <li>מה הרגשת בזמן שהקראנו את הסיפור?</li>
            <li>מה גורם לך להרגיש בטוח כשקשה?</li>
          ...
          <ul style="font-size:15px;padding-right:20px;">
            <li>"אני יכול להבין למה זה הרגיש ככה."</li>
            <li>"זה היה רגע לא פשוט."</li>
            <li>"אהבתי איך התמודדת שם."</li>
            <li>"גם כשקשה, אנחנו יחד בזה."</li>
